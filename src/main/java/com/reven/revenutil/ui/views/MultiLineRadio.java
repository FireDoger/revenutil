 ...
 * on 2022/4/11.
 */
public class MultiLineRadio extends LinearLayout
{
     ...
     * {@inheritDoc}
     */
    public MultiLineRadio(Context context)
    {
        super(context);
     ...
     * {@inheritDoc}
     */
    public MultiLineRadio(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        ...
        if (child instanceof RadioButton)
        {
            child.setOnTouchListener(new OnTouchListener()
            {
                ...
                public boolean onTouch(View v, MotionEvent event)
                {
                    ...
                    {
                        mOnCheckedChangeListener.onCheckedChanged(MultiLineRadio.this, child.getId());
                    }
                    return true;
                }
            });
                ...
                if (view instanceof RadioButton)
                {
                    ...
                    button.setOnTouchListener(new OnTouchListener()
                    {
                        ...
                        public boolean onTouch(View v, MotionEvent event)
                        {
                            ...
                            if (mOnCheckedChangeListener != null)
                            {
                                mOnCheckedChangeListener.onCheckedChanged(MultiLineRadio.this, button.getId());
                            }
                            return true;
                        }
                    });
    ...
    public interface OnCheckedChangeListener
    {
         ...
         */
        void onCheckedChanged(MultiLineRadio group, int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements OnHierarchyChangeListener
    {
        ...
        {
            if (parent == MultiLineRadio.this && child instanceof RadioButton)
            {
                int id = child.getId();
