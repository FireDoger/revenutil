...
public class ControlCheckbox extends CheckBox {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ControlCheckbox, defStyle, 0);
        ...
        if (typedArray != null) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (index == R.styleable.ControlCheckbox_checkbox_bottom_height) {
                    mBottomHeight = typedArray.getDimensionPixelSize(index, -1);

                } else if (index == R.styleable.ControlCheckbox_checkbox_bottom_width) {
                    mBottomWidth = typedArray.getDimensionPixelSize(index, -1);

                } else if (index == R.styleable.ControlCheckbox_checkbox_left_height) {
                    mLeftHeight = typedArray.getDimensionPixelSize(index, -1);

                } else if (index == R.styleable.ControlCheckbox_checkbox_left_width) {
                    mLeftWidth = typedArray.getDimensionPixelSize(index, -1);

                } else if (index == R.styleable.ControlCheckbox_checkbox_right_height) {
                    mRightHeight = typedArray.getDimensionPixelSize(index, -1);

                } else if (index == R.styleable.ControlCheckbox_checkbox_right_width) {
                    mRightWidth = typedArray.getDimensionPixelSize(index, -1);

                } else if (index == R.styleable.ControlCheckbox_checkbox_top_height) {
                    mTopHeight = typedArray.getDimensionPixelSize(index, -1);

                } else if (index == R.styleable.ControlCheckbox_checkbox_top_width) {
